...
public class ProfileController extends AnchorPane implements Initializable {
    ...
    public void setApp(Main application){
        ...
        GlobalScreen.addNativeKeyListener(kd);
        GlobalScreen.addNativeMouseListener(kd);
        GlobalScreen.addNativeMouseMotionListener(kd);
        GlobalScreen.addNativeMouseWheelListener(kd);
